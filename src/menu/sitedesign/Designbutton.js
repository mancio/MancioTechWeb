    ...
    return(
        <div className='button'>
            <svg xmlns="http://www.w3.org/2000/svg" width="231" height="43" viewBox="0 0 231 43">
                ...
                <text id="SITE_DESIGN" data-name="SITE DESIGN" transform="translate(32 33)" stroke="rgba(0,0,0,0)" strokeWidth="1" fontSize="25" letterSpacing="0.04em"><tspan x="0" y="0">SITE DESIGN</tspan></text>
            </svg>
        </div>
    )
}
